...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"joinRoom.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getIntoRoom = void 0;
...
var getIntoRoom = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(username, room) {
    var res;
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              window.setTimeout(function () {
                location.assign("/chat/".concat(username));
              }, 1500);
            }
  ...
  return function getIntoRoom(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.getIntoRoom = getIntoRoom;
...
var joinForm = document.querySelector(".joinForm"); //const algo = document.querySelector(".algo");
